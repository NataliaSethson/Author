  ...
  return (
    <div className={styles.container}>
        ...
        <div className={styles.text_content}>
            <p>Larssen was born in Noblesville, Indiana in 1977. His imagination traverses the realms of fantasy, thrillers, and science fiction. The diverse landscapes of Indiana, with its blend of urban and rural settings, provide a rich backdrop for his storytelling.
            ...
            When not weaving narratives, Larssen is often found exploring the hidden nooks of Indiana or nestled in a local café, dreaming up his next literary adventure. His work invites readers on a journey to unseen worlds, skillfully blending the extraordinary with the familiar, and always carrying a hint of Indiana's spirit in every story.</p>
        </div>
